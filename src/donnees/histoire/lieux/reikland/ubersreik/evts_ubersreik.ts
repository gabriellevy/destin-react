    ...
    evts: [
        ...
        },
        {
            ...
            description: (perso: Perso): ResultatExecution => {
                ...
                return {texte: "De passage à ubersreik et sans logement vous décidez de vous installer à l'auberge de la maison du pont. " +
        ...
        },
        {
            ...
            description: (perso: Perso): ResultatExecution => {
                ...
                return {texte: "Vous avez réussi à vous trouver un travail de serveur à l'auberge de la maison du pont. " +
