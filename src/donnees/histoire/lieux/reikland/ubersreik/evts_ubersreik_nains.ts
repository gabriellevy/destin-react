    ...
    evts: [

        {
            ...
            description: (perso: Perso): ResultatExecution => {
                ...
                return {texte: "De passage à ubersreik et sans logement vous décidez de vous installer à 'La hache et le marteau'. " +
        ...
        },
        {
            ...
            description: (): ResultatExecution => { return { texte: "Aujourd'hui vous vous offrez un petit plaisir: vous allez diner et boire un bon coup à 'La hache et le marteau'. " +
        ...
        },
        {
            ...
            description: (perso: Perso): ResultatExecution => {
                ...
                return { texte: "Vous avez réussi à vous trouver un travail de serveur à 'La hache et le marteau'. " +
